      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              ...
              {values.map((value, index) => (
                <div key={index} className="flex items-start gap-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary-100 rounded-lg flex items-center justify-center flex-shrink-0">
                    <value.icon className="w-5 h-5 sm:w-6 sm:h-6 text-primary-600" />
                  </div>
                  <div>
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl sm:rounded-3xl transform rotate-3"></div>
            <div className="relative bg-gray-900 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 text-white">
              <h3 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8">{t('about.process.title')}</h3>
