...
{t('hero.exploreWork')}
        ...
        <div className="mt-20 grid grid-cols-3 gap-8 text-center animate-fade-up delay-300">
          <div>
            ...
            <p className="text-gray-400">{t('hero.stats.appsDelivered')}</p>
          </div>
          <div>
            <h3 className="text-4xl font-bold text-white mb-2">98%</h3>
            <p className="text-gray-400">{t('hero.stats.clientSatisfaction')}</p>
          </div>
          <div>
            <h3 className="text-4xl font-bold text-white mb-2">5M+</h3>
            <p className="text-gray-400">{t('hero.stats.downloads')}</p>
          </div>
        </div>
      </div>
